...
let currentUserId = null; // ✅ FIXED: Added global currentUserId declaration
...
async function initUserDatabase() {
    ...
    // ✅ FIXED: Use global currentUserId variable
    if (!currentUserId) {
...
async function checkAuth() {
    ...
    // ✅ FIXED: Don't redeclare currentUserId here - use the global variable
    ...
    if (userStr) {
        try {
            ...
            currentUserId = currentUser.id; // ✅ Set the global variable
