...
console.log("window.dbAPI exists:", typeof window.dbAPI !== 'undefined');
console.log("window.dbAPI.initDatabaseForUser exists:", typeof window.dbAPI?.initDatabaseForUser);
...
async function login() {
    ...
    try {
        ...
        if (data.success) {
            ...
            const dbInitialized = await initUserDatabase();
            if (!dbInitialized) {
                errorEl.textContent = "Failed to initialize database. Please refresh and try again.";
                return;
            }
...
async function register() {
    ...
    try {
        ...
        console.log("User object from registration:", data.user);
