// app.js - COMPLETE version with FIXED authentication
...
// FIXED Login function - uses direct API calls
async function login() {
    const emailField = document.getElementById("authEmail");
    const passwordField = document.getElementById("authPassword");
    
    // Check if fields exist - important for main app
    ...
    try {
        // DIRECT API CALL - no auth.js dependency
...
// FIXED Register function - uses direct API calls
