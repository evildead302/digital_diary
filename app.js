// app.js - FIXED VERSION WITH PROPER AUTH FLOW
...
async function login() {
    ...
    try {
        ...
        if (data.success && data.token && data.user) {
            ...
            if (errorEl) errorEl.textContent = data.message || "Login failed. Please check your credentials.";
            if (statusEl) statusEl.textContent = "";
        }
    } catch (error) {
...
async function register() {
    ...
    try {
        ...
        if (data.success && data.token && data.user) {
            ...
            if (errorEl) errorEl.textContent = data.message || "Registration failed. User may already exist.";
            if (statusEl) statusEl.textContent = "";
        }
    } catch (error) {
...
console.log("✅ app.js FIXED VERSION loaded with proper auth flow");
